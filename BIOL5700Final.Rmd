...
pacman::p_load(ggplot2, dplyr, tidyr, reshape, iNEXT, knitr, kableExtra, ggfortify, ggpubr, vegan, geosphere, mclust, rgdal, leaflet)
...
Plots were sampled at 27 independent sites throughout a subset of the Eastern Highland Rim ecoregion. 
...
Sites had differing dominant vegetation types; click the points below for details. Also note that some sites were also in close proximity, making them difficult to see at broader zoom levels.
